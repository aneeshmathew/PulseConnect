...
// Always resolves to `true` on the backend regardless of whether the email
// is registered — the UI should show the same "check your inbox" message
// either way so the mutation can't be used to enumerate accounts.
